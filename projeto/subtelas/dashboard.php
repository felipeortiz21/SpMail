...
if(isset($_REQUEST["mensagem"])){
	$id_mensagem = (int) $_REQUEST["mensagem"];
}else{
...
<div class="area" id="loadArea">
	<div class="wrap so_tabela">
		...
		<h1>Dashboard</h1>
		<div class="seletor-campanha">
			<label for="id_men_modal">Campanha:</label>
			<select id="id_men_modal" onchange="$.colorbox({href: 'subtelas/dashboard.php?mensagem='+this.value});">
				<?php
		...
		?>
			<div class="area_tabela">
				<div class="tabela">
					...
					<div class="opcoes">
						<div>
							<input type="radio" name="rr<?php echo (int) $mRow["id"]; ?>" id="check<?php echo (int) $mRow["id"]; ?>" rel="clicou" value="Clicou :D" onclick="filtrar(<?php echo (int) $mRow["id"]; ?>,2,'')"/>
						...
						<div>
							<input type="radio" name="rr<?php echo (int) $mRow["id"]; ?>" id="check<?php echo (int) $mRow["id"]; ?>x" value="Ignorado" onclick="filtrar('<?php echo (int) $mRow["id"]; ?>',2,'x')"/>
							<label for="check<?php echo (int) $mRow["id"]; ?>x">Ignorados</label>
						</div>
						<div>
